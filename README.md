...
@theme inline {
  ...
  --font-sans: var(--font-slackside-one);
  --font-mono: var(--font-lxgw-wenkai-mono-tc);
...
@layer base {
  * {
  ...
  h5,
  h6 {
    font-family: var(--font-slackside-one), cursive;
  }
  body {
    @apply bg-background text-foreground;
    font-family: var(--font-lxgw-wenkai-mono-tc), monospace;
    /* min-height: 100vh; */
