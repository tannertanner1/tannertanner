  ...
  */
  ...
  export interface DownloadVerificationDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * 
    **/
    createManyAndReturn<T extends DownloadVerificationCreateManyAndReturnArgs<ExtArgs>>(
      args?: SelectSubset<T, DownloadVerificationCreateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<$Result.GetResult<Prisma.$DownloadVerificationPayload<ExtArgs>, T, 'createManyAndReturn'>>
